...
public class UserOrdersController {
    ...
    @GetMapping("/search")
    public ResponseEntity<List<ServicesModel>> searchServicesByCity(@RequestParam String city) {
        try {
            List<ServicesModel> searchResults = userOrdersService.searchServicesByCity(city);
